...
pub trait is_server_or_owner {
    ...
    fn is_server_or_owner(&self, sobj_id: StellarObjectId) -> __sdk::Result<()>;
...
impl is_server_or_owner for super::RemoteReducers {
    fn is_server_or_owner(&self, sobj_id: StellarObjectId) -> __sdk::Result<()> {
        self.imp
            .call_reducer("is_server_or_owner", IsServerOrOwnerArgs { sobj_id })
    }
    fn on_is_server_or_owner(
        &self,
        ...
        IsServerOrOwnerCallbackId(self.imp.on_reducer(
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event:
                        __sdk::ReducerEvent {
                            reducer: super::Reducer::IsServerOrOwner { sobj_id },
                            ..
                        },
                    ..
                } = ctx
