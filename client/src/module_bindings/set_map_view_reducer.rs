...
#[sats(crate = __lib)]
pub(super) struct SetMapViewArgs {
    pub new_view: MapView,
}

impl From<SetMapViewArgs> for super::Reducer {
...
pub struct SetMapViewCallbackId(__sdk::CallbackId);

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `set_map_view`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait set_map_view {
    /// Request that the remote module invoke the reducer `set_map_view` to run as soon as possible.
    ///
...
impl set_map_view for super::RemoteReducers {
    ...
    fn remove_on_set_map_view(&self, callback: SetMapViewCallbackId) {
        self.imp.remove_on_reducer("set_map_view", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `set_map_view`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_set_map_view {
    /// Set the call-reducer flags for the reducer `set_map_view` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn set_map_view(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_set_map_view for super::SetReducerFlags {
    fn set_map_view(&self, flags: __ws::CallReducerFlags) {
