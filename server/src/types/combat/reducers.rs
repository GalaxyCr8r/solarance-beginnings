...
// //#[spacetimedb::reducer]
// pub fn _process_combat_actions(ctx: &ReducerContext) -> Result<(), String> {
//     let dsl = dsl(ctx);
...
//                 match _process_weapon_combat_action(ctx, source_sobj_id, target_sobj_id) {
//                     Ok(_) => {
...
//             if let Some(target_sobj_id) = controller.get_targeted_sobj_id() {
//                 match _process_missile_combat_action(ctx, source_sobj_id, target_sobj_id) {
//                     Ok(_) => {
//                         spacetimedb::log::info!(
...
// fn _process_weapon_combat_action(
//     ctx: &ReducerContext,
//     source_sobj_id: u64,
//     target_sobj_id: u64,
// ) -> Result<(), CombatError> {
...
// fn _process_missile_combat_action(
//     ctx: &ReducerContext,
//     source_sobj_id: u64,
//     target_sobj_id: u64,
// ) -> Result<(), CombatError> {
